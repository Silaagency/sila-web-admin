        ...
        apiData.map((x) => (
          <div className="ad-account">
            <div className='top-section'>
              ...
              <div className="right-section">
                ...
                <div className="user-phone">
                  ...
                  <p>User phone number: {x.phoneNumber}</p>
                </div>
              </div>
            </div>
            ...
            <div className="shopify-shop">
              ...
              <p>Shopify screenshot:</p>
              {
                x.shopifyScreenshot !== '' ? (
                  <img src={x.shopifyScreenshot} alt="" />
                ) : (
            ...
            <div className="total-cost">
              ...
              <p>Total cost: {x.totalCost} USD</p>
            </div>

            {
              ((x.status === 'Pending') || (x.status === 'Renewal')) && (
                <div className="decision">
                  ...
                  <input onChange={(e) => setAdAccountId(e.target.value)} type="text" placeholder='Ad account id...' />

                  <div onClick={() => reject(x._id)} className="reject">
                    {
                      rejectedLoading ? (
                        <RingLoader color={'#123abc'} loading={true} css={override} size={20} />
                      ) : (
            ...
            <div onClick={() => deleteAd(x._id)} className='delete-button'>
